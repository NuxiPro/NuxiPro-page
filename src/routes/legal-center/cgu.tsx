        ...
        <nav className="sticky top-24 rounded-2xl border border-hairline bg-white/60 backdrop-blur p-5">
          ...
          <ul className="space-y-1 text-[13px] leading-none">
            <li>
              ...
              >
                <span className={`h-1.5 w-1.5 rounded-full shrink-0 transition-colors ${active === "landing" ? "bg-teal" : "bg-teal/50"}`} />
                {t("legal.privacy.landingPage.title")}
              </a>
            </li>
            <li>
              ...
              >
                <span className={`h-1.5 w-1.5 rounded-full shrink-0 transition-colors ${active === "demo" ? "bg-teal" : "bg-teal/50"}`} />
                {t("legal.privacy.demo.title")}
              </a>
            </li>
          </ul>
